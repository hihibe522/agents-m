...
<EXTREMELY_IMPORTANT>
  ...
  **Operational Mandate:**
  ...
  1. At the start of every session or task, you MUST check if any skill applies.
  2. Follow the rules defined in the \`using-superpowers\` skill.
  3. If there is even a 1% chance a skill applies (e.g., debugging, planning brainstorming), you MUST invoke it.
  4. Always prioritize discipline and systematic workflows over speed.
